...
/**
 * Beta incompleta regularizada I_x(a,b), vía fracción continua
 * (algoritmo estándar, ver Numerical Recipes cap. 6.4).
 *
 * CORREGIDO (ago 2026): la versión anterior no aplicaba la simetría
 * I_x(a,b) = 1 - I_(1-x)(b,a) cuando x está cerca de 1 (que es
 * justamente el caso más común: t-stats chicos con n grande, o sea, la
 * gran mayoría de las correlaciones reales). Sin esa simetría, la serie
 * no converge bien en esa región y el p-value sale sistemáticamente
 * demasiado bajo — se detectó con un control negativo (datos 100% al
 * azar marcados como "significativos" en 5 de 5 corridas, cuando debería
 * ser ~1 de cada 20). Validado contra valores de referencia conocidos
 * antes de este fix.
 */
