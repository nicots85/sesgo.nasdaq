...
function calculateBias(market, correlations, newsAnalysis) {
  ...
  const factors = [
    {
      name: 'Caja overnight',
      description: 'Backtest 515 días: alcista 56.7% continuación (+0.67% prom)',
      score: 56.7,
      weight: 0.35,
      raw: 56.7
    },
...
async function getBias() {
  ...
  const bias = calculateBias(market, correlations, news.analysis);
